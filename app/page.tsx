      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 pb-16 pt-16 lg:grid-cols-[1.25fr_0.9fr] lg:pb-24 lg:pt-24">
          <Reveal>
            ...
            <h1 className="mt-8 max-w-4xl text-5xl font-black tracking-normal text-slate-950 text-balance md:text-7xl">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-6 text-sm font-semibold text-muted-foreground">
          ...
          <div className="space-y-7">
            {heroFeatures.map((feature, index) => (
              <Reveal key={feature.title} delay={150 + index * 100}>
        ...
        <Reveal delay={200} className="mx-auto max-w-6xl px-6 pb-10">
          <ProductMockup />
        </Reveal>
      </section>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {pricingTiers.map((plan, index) => (
              <Reveal key={plan.name} delay={index * 100}>
                <div className="flex h-full items-center justify-between gap-4 rounded-2xl border border-border bg-white p-6 shadow-sm">
                  <div>
